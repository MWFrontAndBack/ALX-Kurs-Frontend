...
const jsonList = JSON.stringify(initialization);
localStorage.setItem("trains", jsonList);
...
const removeAllConections = () => {
    console.log('delete localstorage')
    localStorage.clear()
    render(trains)
}

removeButton.addEventListener('click', removeAllConections)
